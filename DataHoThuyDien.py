...
def create_database():
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS ho_thuy_dien (
...
def insert_data(data):
    ...
    for entry in data:
        # Extract timestamp from the date string using a regular expression
...
# Main execution
api_url = 'http://qndnapi.vndss.com/service/getDataHoThuyDien'
